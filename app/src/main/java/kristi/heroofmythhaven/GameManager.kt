...
class GameManager{
    ...
    fun update() {
        var movementContext = false // Determines if the background and game objects can move or if the player can move
        // Their relation ship is inversely related

        var bottomCollision = false // Used to fix a bug where the player could walk off a landing and be floating in the air
